...
namespace IdentityServer.Models
{
    public partial class IdentityServerContext : DbContext
    {
        ...
        public virtual DbSet<UsersClientsRoles> UsersClientsRoles { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=localhost;database=IdentityServer;trusted_connection=yes;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<UsersClientsRoles>(entity =>
            {
                entity.Property(e => e.Id).ValueGeneratedNever();

                entity.HasOne(d => d.Client)
                    .WithMany(p => p.UsersClientsRoles)
                    .HasForeignKey(d => d.ClientId)
                ...
                entity.HasOne(d => d.UserRole)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_UsersClientsRoles_UsersRoles_UsersRolesId");
            });
